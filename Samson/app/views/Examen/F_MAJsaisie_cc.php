...
<script type="text/javascript">
    ...
    function EnregistrementCC(cc,idetudiant,iduvmatiere)
    {
        ...
        xhr.open("GET","../Ajaxviews/Saisiecc_etudiant.php?cc_etudiant="+cc+"&idmatiere="+iduvmatiere+"&idetudiant="+idetudiant, true);
...
<caption><h2 style="text-align-last:center;color:red; "><strong>Grille de Mise a jour des notes de controle continu</strong></h2></caption>
<tr id="titrerubrique">
       ...
       <tr style="display:none"><td><input type="text" class="ccetudiant_' . $idetudiant . '" name="ccetudiant_' . $idetudiant . '"  value=' . $ligne[1] . '></td></tr>
        ...
        <script>
                  ...
                  <tr class="row_' . $idetudiant . '">
                                   ...
                                   ';?>
    <td id="tr" width="25%"><input value="<?php echo($ligne['cc']);?>" type="text" class="<?php echo'ccetudiant1_' . $idetudiant . '';?>"  name="<?php echo'ccetudiant1_' . $idetudiant . '';?>" size="20" onkeypress="InsertAn(event,<?php echo $idetudiant; ?>,<?php echo $idmatiere; ?>)"></td>
