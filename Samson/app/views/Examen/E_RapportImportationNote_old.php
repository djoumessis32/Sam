...
foreach($data as $ligne)
	{
		...
		if($idetudiantevaluernote==""){
			...
			$reqinsert1="INSERT INTO evaluernoteetudiantpondere (idsemestre,idsession,iduvmatiere,idspecialite,idetudiant,cc) values ($semestreAcad,$sessioncad,$matiereAcad,$specialite,$idetudiant,".$datafin[2].")";
			$test=$con->exec($reqinsert);
			$test1=$con->exec($reqinsert1);
			if($test==true){
			...
			elseif($general==2)
			{
               	$reqinsert="INSERT INTO evaluernoteetudiant (idsemestre,idsession,iduvmatiere,idspecialite,idetudiant,cc,examen) values ($semestreAcad,$sessioncad,$matiereAcad,$specialite,$idetudiant,".$datafin[1].",".$datafin[2].")";
				$reqinsert1="INSERT INTO evaluernoteetudiantpondere (idsemestre,idsession,iduvmatiere,idspecialite,idetudiant,cc,examen) values ($semestreAcad,$sessioncad,$matiereAcad,$specialite,$idetudiant,".$datafin[1].",".$datafin[2].")";
				$test=$con->exec($reqinsert);
				$test1=$con->exec($reqinsert1);
			if($test==true){
					echo"<tr style='background-color:aqua;'><td>".$b."</td><td >".$datafin[0]."</td><td>".$datafin[1]."</td><td>".$datafin[2]."</td></td><td>Importer avec Succès !!</td></tr>";
					$b++;;
				}else{
					echo"<tr style='background-color:red;'><td>".$b."</td><td>".$ligne."</td><td>Echec</td></tr>";
					$echec++;
					...
					$reqinsert1="INSERT INTO evaluernoteetudiantpondere (idsemestre,idsession,iduvmatiere,idspecialite,idetudiant,examen) values ($semestreAcad,$sessioncad,$matiereAcad,$specialite,$idetudiant,".$datafin[2].")";
				$test=$con->exec($reqinsert);
				$test1=$con->exec($reqinsert1);
			if($test==true){
					echo"<tr style='background-color:aqua;'><td>".$b."</td><td >".$datafin[0]."</td><td>".$datafin[2]."</td></td><td>Importer avec Succès !!</td></tr>";
			...
			if($general==1){
				...
				$requpdate1 = "update evaluernoteetudiantpondere set cc = ".$datafin[2]." where idetudiant = $idetudiantevaluernote";
				$testupdate=$con->exec($requpdate);
				$testupdate1=$con->exec($requpdate1);
				echo"<tr style='background-color:aqua;'><td>".$b."</td><td >".$datafin[0]."</td><td>".$datafin[2]."</td></td><td>Maj avec Succès !!</td></tr>";
					$b++;;
			}
			elseif ($general==2){
				$requpdate = "update evaluernoteetudiant set cc = ".$datafin[1].", examen = ".$datafin[2]." where idetudiant = $idetudiantevaluernote";
				$requpdate1 = "update evaluernoteetudiantpondere set cc = ".$datafin[1].", examen = ".$datafin[2]." where idetudiant = $idetudiantevaluernote";
				$testupdate=$con->exec($requpdate);
				$testupdate1=$con->exec($requpdate1);
				echo"<tr style='background-color:aqua;'><td>".$b."</td><td >".$datafin[0]."</td><td>".$datafin[1]."</td><td>".$datafin[2]."</td><td>Maj avec Succès !!</td></tr>";
					$b++;;
				
			}
			else{
				$requpdate = "update evaluernoteetudiant set examen = ".$datafin[2]." where idetudiant = $idetudiantevaluernote";
				$requpdate1 = "update evaluernoteetudiantpondere set examen = ".$datafin[2]." where idetudiant = $idetudiantevaluernote";
				$testupdate=$con->exec($requpdate);
				$testupdate1=$con->exec($requpdate1);
				echo"<tr style='background-color:aqua;'><td>".$b."</td><td >".$datafin[0]."</td><td>".$datafin[2]."</td></td><td>Maj avec Succès !!</td></tr>";
					$b++;;
