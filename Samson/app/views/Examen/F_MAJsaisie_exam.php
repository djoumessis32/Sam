...
<caption><h2 style="text-align-last:center;color:red; "><strong>Grille de Mise a jour des notes d\'examen</strong></h2></caption>
<tr id="titrerubrique">
...
while ($ligne = $result->fetch()) {
    ...
    <td id="tr" width="25%"><input  value="<?php echo($ligne['examen']);?>" type="text" class="<?php echo'ccetudiant1_' . $idetudiant . '';?>"  name="<?php echo'ccetudiant1_' . $idetudiant . '';?>" size="20" onkeypress="InsertAn(event,<?php echo $idetudiant; ?>,<?php echo $idmatiere; ?>)"></td>
