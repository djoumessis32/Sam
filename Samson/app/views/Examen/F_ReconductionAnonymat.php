...
<form target="e" method="post"  class="form-horizontal" action="app/views/Examen/E_ImprimerPVReconductionAnonymat.php"  name="ajouteruser" id="formUser">
    <center>
            ...
            <tr>
                <td>
                    <button class="btn btn-success" id="send">
                        Reconduire Anonymat <span class=' icon-circle-arrow-right'></span>
                    </button>
                </td>
                <td>
