...
<center><h2 style="text-align-last:center;color:red; "><strong>Proces verbal Final</strong></h2></center>
...
while ($ligne = $result->fetch()) {
    ...
    $pq=null;
    $desc=null;
    if($ligne['notefinale']>=0){$notef=$ligne['notefinale'];}
    if($ligne['notefinale']>=0){$grade=$ligne['grade'];}
    if($ligne['notefinale']>=0){$pq=$ligne['pq'];}
    if($ligne['notefinale']>=0){if($ligne['is_valid']==2){$desc='VA';}elseif($ligne['is_valid']==1){$desc='NV';}else{$desc='EL';}}
    ...
    echo '<div>
                  <tr class="row_' . $idetudiant . '">
                                   ...
                                   <td id="tr2" width="5%"><b>' .$anonymat. '</b></td>
    <td id="tr" width="5%">'.$cc.'</td>
    <td id="tr" width="5%">'.$exam.'</td>
    <td id="tr" width="5%">'.$notef.'</td>
    <td id="tr" width="5%">'.$pq.'</td>
    <td id="tr" width="5%">'.$grade.'</td>
    <td id="tr" width="5%">'.$desc.'</td>
    </tr>
    </div>';
    $i++;
}
