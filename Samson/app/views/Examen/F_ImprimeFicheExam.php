...
<form target="e" method="post"  class="form-horizontal" action="app/views/Examen/E_ImprimerFicheAnonymat.php"  name="ajouteruser" id="formUser">
    <center>
            ...
            <tr>
                <td>
                    <button class="btn btn-success" id="send">
                        Imprimer Fiche  <span class=' icon-print'></span>
                    </button>
                </td>
                <td>
