...
<form target="_blank" method="post"  class="form-horizontal" action="app/views/Examen/F_MAJsaisie_anonymat.php"  name="ajouteruser" id="formUser">
    <center>
            ...
            <tr>
                <td>
                    <button class="btn btn-success" id="send">
                        Aller Mettre a jour <span class=' icon-arrow-right'></span>
                    </button>
                </td>
                <td>
