 ...
 * Time: 1:12 AM
 */
$date_actuelle=date('yy-m-d');
?>

<form target="_blank" method="post"  class="form-horizontal" action="app/views/Examen/F_saisie_cc.php"  name="ajouteruser" id="formUser">
    <center>
        ...
        <tr>
                <td>
                    <button class="btn btn-success" id="send">
                        Aller saisir <span class=' icon-arrow-right'></span>
                    </button>
                </td>
                <td>
