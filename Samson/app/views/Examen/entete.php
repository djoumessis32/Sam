...
$annee = null;
	...
	$lib_classelmd = ($classelmd != 0) ? getLibelle('semestrelmd','idsemestrelmd','codesemestrelmd',$classelmd,$con) : '';
...
<table align="center" class="tableEnteteLogo" border=0 cellspacing=0 cellpadding=0 width='95%' > 
 <tr>
   ...
   <td align="center">
       <img  style="border-radius:5px" src="../../../assets/img/LOGO_IUSTY.jpg" align="center" height="120" width="170">
   </td>
   <td  width="40%">
