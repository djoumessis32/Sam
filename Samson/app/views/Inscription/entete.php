...
function enteteEtat($an=0,$filiere=0,$specialite=0,$classelmd=0,$semestr=0,PDO $con) {
$id=$_SESSION['campus'];
$req="SELECT * FROM etablissement INNER JOIN campus on campus.idetablissement=etablissement.idEtablissement WHERE idcampus=$id";
$rep=$con->query($req);
...
<table align="center" class="tableEnteteLogo" border=0 cellspacing=0 cellpadding=0 width='95%' > 
 <tr>
   ...
   <p class="paysfinal2">Republic of Cameroon</p>
       ...
       <p class="devisefinal"><i>Peace-Work-Fatherland</i></p>
       <p class="univfinal">Ministère de l' Enseignement Supérieur</p>
   ...
   <td align="center">
       <img  style="border-radius:5px" src="..\..\..\assets\img\LOGO_IUSTY.jpg" align="center" height="140" width="170">
   </td>
   <td  width="40%">
       <p class="facfinal"><?php echo  $school[4]?></p>
       <p class="facfinal2"><?php echo $school[3]?></p>
       <p class="facfinal1"><?php echo  $school['libellecampus_fr']?></p>
       <p class="facfinal21"><?php echo $school['libellecampus_en']?></p>
       <p class="fac">La Direction</p>
       <p class="devise">The Direction</p>
       <p class="adressefinal"> BP : <?php echo  $school[9]." ".$school['lieusignatuure']; ?></p>
       <p class="adressefinal">T&eacute;l  : <?php echo  $school['telcampus'] ?></p>
     ...
     <tr>
        <td class="leftEntete" width="50%">
         <?php 
          ...
          if($semestr!=''){echo'<p class="simple"><span class="cle">Semestre LMD : </span><span class="valeur">'.ucfirst($semestr).'</span></p>';}
          //$lib_semestreLMD
       echo' </td>';
        echo'<td width="33%" align="left">';
		  ...
		  if($lib_classelmd!=''){echo'<p class="simple"><span class="cle">Classe LMD : </span><span class="valeur"> '.$lib_classelmd.'</span></p>';}
