...
<div style="margin-top:-5px;">
    <table id="tableform" style="margin-left: 0.25%;">
        ...
        <?php
        $reqPgrm="select distinct idprogrammeannuel 
...
and specialite.id=$specialite
and programmadopte.idanneeacademique=$idannneeAcad";
      //      echo($reqPgrm);
        $repPrgm=$db->query($reqPgrm);
        while($prog=$repPrgm->fetch()){
            $sommeStre=0;
            $reqUE="select distinct iduniteenseignement, codeuniteenseignement,libelleuniteenseignement,nbcreditsue,notevalidationue,noteeleminerue 
...
and specialite.id=$specialite 
ORDER BY codeuniteenseignement ASC
";
//	echo $reqUE;
