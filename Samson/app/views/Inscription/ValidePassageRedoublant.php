...
if($p5==1){
        ...
        $tes2=$con->exec("INSERT INTO preinscription(idetudiant,idsemestre,idspecialite,pass,idannee,is_inscrit,datepreinscription)VALUES($idetudiant,$semestre,$specialite,1,$anneeAcad,0,'$datejour');");
}
}
}
if($tes2==true ){
             echo '<script language="javascript">alert("Inscription Redoublant effectué Avec Success!"); </script>';
				}else {
