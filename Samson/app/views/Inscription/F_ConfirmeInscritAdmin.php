...
//alert("salut");
			 var xhr = getXhr();			
			    ...
			    xhr.open("GET","app/views/Ajaxviews/E_ListePreinscrit.php?eltcles="+eltcles+"&idanneeAcad="+idanneeAcad,true);
...
//alert("salut");
			 var xhr = getXhr();			
				...
				var chainepaye = 1;	
				var idanneeAcad = document.getElementById('idanneeAcad').value;               				
			    xhr.open("GET","app/views/Ajaxviews/E_ListePreinscrit.php?chainepaye="+chainepaye+"&idetudiant="+idetudiant+"&idanneeAcad="+idanneeAcad,true);
...
//alert("salut");
			 var xhr = getXhr();			
                ...
                xhr.open("GET","app/views/Ajaxviews/E_ListePreinscrit.php?chaineIdpaye="+chaineIdpayeFinal+"&idetudiant="+idetudiant+"&chaineIdpayeRecu="+chaineIdpayeRecu,true);
				xhr.setRequestHeader('Content-Type','application/x-www-form-urlencoded');
				xhr.send(null);
...
<fieldset class="admintable">
  <legend>Rechercher des etudiants</legend>   
   <!-- affichage des etudaints -->	 
    <table border='0' class="admintable" width="100%">
        <tr>
         	<td width="60%" class="key">NumDossier/Noms/Prenoms:</td>
