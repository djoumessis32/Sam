...
//echo $reqsemestre;
  ...
  <div class="card card-body">
     <h3><center><strong>Inscription des Redoublants</strong><br></h3>
...
while($ligne=$rep->fetch()){
	...
	echo'<form method="POST" action="app/views/Inscription/ValidePassageRedoublant.php" target="new" name="form">
