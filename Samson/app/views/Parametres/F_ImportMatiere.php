...
<div class="row-fluid">
            ...
            <div class="span12">
                <div class="box">
					...
					<form name="imporForm" id="imporForm" target="_blank" action="app/views/Parametres/E_RapportImportationMatiere.php" method="post">
                            <table class="table responsive">
								...
								foreach ($champs as $champ) {
									...
									<?php
                                                    echo$function->getListAttributMatiere($champ);
                                                ?>
												 </td>
                                        </tr>
										 <?php
