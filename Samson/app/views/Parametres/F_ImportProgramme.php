...
<div class="row-fluid">
            ...
            <div class="span12">
                <div class="box">
					...
					<form name="imporForm" id="imporForm" target="_blank" action="app/views/Parametres/E_RapportImportationPgr.php" method="post">
                            <table class="table responsive">
								...
								foreach ($champs as $champ) {
									...
									<?php
                                                    echo$function->getListAttributProgramme($champ);
                                                ?>
												 </td>
                                        </tr>
										 <?php
